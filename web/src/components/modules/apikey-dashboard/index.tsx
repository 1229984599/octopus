                    ...
                    <div className="overflow-hidden rounded-3xl border bg-card">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="relative flex flex-col justify-center border-t bg-muted/30 p-6 md:border-l md:border-t-0 md:p-8">
                                ...
                                <div className="text-lg text-muted-foreground uppercase tracking-wider mb-2">{t('requestCount')}</div>
                                <div className="text-6xl font-bold text-chart-4">
                                    <AnimatedNumber value={stats.request_count.formatted.value} />
                                    <span className="text-lg font-normal text-muted-foreground ml-1">{stats.request_count.formatted.unit}</span>
                                </div>
                                <div className="mt-4 grid grid-cols-2 gap-3 text-sm text-muted-foreground">
                                    <div className="rounded-xl border bg-background/60 p-3">
                                        <div>{t('successRequests')}</div>
                                        <div className="mt-1 text-lg font-semibold text-foreground"><AnimatedNumber value={stats.request_success.formatted.value} /><span className="ml-1 text-xs font-normal text-muted-foreground">{stats.request_success.formatted.unit}</span></div>
                                    </div>
                                    <div className="rounded-xl border bg-background/60 p-3">
                                        <div>{t('failedRequests')}</div>
                                        <div className="mt-1 text-lg font-semibold text-foreground"><AnimatedNumber value={stats.request_failed.formatted.value} /><span className="ml-1 text-xs font-normal text-muted-foreground">{stats.request_failed.formatted.unit}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
